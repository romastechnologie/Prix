    ...
    const addFormToCollection = (e) => {
        if(container != null)
        {
           // var container = document.querySelector('[data-call-form="ajax"]');
            ...
            div.innerHTML = prototype.replace(/__name__/g,collectionHolder.dataset.index);

            if ($(collectionHolder).hasClass("collection-form-child"))
            {
                div.innerHTML = prototype.replaceAll(/__subname__/g, collectionHolder.dataset.index);
            }
            ...
            console.log(container.querySelectorAll('.add_livraison_item_link'));
            container.querySelectorAll('.add_livraison_item_link').forEach(btn => {
