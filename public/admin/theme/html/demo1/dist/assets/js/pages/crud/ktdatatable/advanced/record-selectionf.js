...
var KTDatatableRecordSelectionDemo = (function () {
    ...
    var t = {
        data: { type: "remote", source: { read: { url: HOST_URL } }, pageSize: 10, serverPaging: !0, serverFiltering: !0, serverSorting: !0 },
        layout: { scroll: !1, footer: !1 },
        sortable: !0,
        pagination: !0,
        columns: [
            { field: "RecordID", title: "#", sortable: !1, width: 20, selector: !0, textAlign: "center" },
            ...
            { field: "ShipDate", title: "Ship Date", type: "date", format: "MM/DD/YYYY" },
            {
                ...
                template: function (t) {
                    ...
                    return '<span class="label label-lg font-weight-bold' + e[t.Status].class + ' label-inline">' + e[t.Status].title + "</span>";
                },
            },
            {
                field: "Type",
    ...
    return {
        init: function () {
            !(function () {
                (t.extensions = { checkbox: !0 }), (t.search = { input: $("#kt_datatable_search_query"), key: "generalSearch" });
                ...
                $("#kt_datatable_search_status").on("change", function () {
                    ...
                    $("#kt_datatable_fetch_modal")
                        .on("show.bs.modal", function (t) {
                            ...
                            console.log(a);
                            for (var l = document.createDocumentFragment(), n = 0; n < a.length; n++) {
                                var s = document.createElement("li");
                                s.setAttribute("data-id", a[n]), (s.innerHTML = "Selected record ID: " + a[n]), l.appendChild(s);
                            }
                ...
                (function () {
                    (t.extensions = { checkbox: !0 }), (t.search = { input: $("#kt_datatable_search_query_2"), key: "generalSearch" });
                    ...
                    $("#kt_datatable_search_status_2").on("change", function () {
                        ...
                        e.on("datatable-on-click-checkbox", function (t) {
                            ...
                            $("#kt_datatable_selected_records_2").html(a), a > 0 ? $("#kt_datatable_group_action_form_2").collapse("show") : $("#kt_datatable_group_action_form_2").collapse("hide");
                        }),
